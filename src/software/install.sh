...
function set_software_list() {
    ...
    gaming_list=(
        ...
        ["Prism Launcher (Minecraft)"]="prismlauncher-qt5 java-latest-openjdk"
...
function select_and_install() {
    ...
    echo "{BLUE}::${RESET} Packages to install (e.g., 1 2 3, 1-3, all or press enter to skip): "
    read -ra input
...
function install_software() {
    ...
    select_and_install desktop_list "Desktop Apps"
