...
sudo pacman -S --noconfirm --needed intel-media-driver intel-gmmlib onevpl-intel-gpu xf86-video-intel xorg-xrandr egl-wayland nvidia-utils lib32-nvidia-utils nvidia-settings lib32-opencl-nvidia libvdpau-va-gl libvdpau libva-nvidia-driver cuda nvidia-open-dkms nvidia-prime
...
First verify it works before making a desktop launcher.
